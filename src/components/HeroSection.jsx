      ...
      <main className="relative z-10 flex flex-col items-center text-center py-20 px-4 sm:px-6 lg:px-8">
        <div className="glass-morphism rounded-xl p-8 md:p-12 lg:p-16 max-w-4xl w-full animate-scale-in">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up animation-delay-400">
            <button className="w-full sm:w-auto flex items-center justify-center gap-2 bg-primary text-white font-bold py-3 px-6 rounded-lg transition-all duration-300 hover:shadow-[0_0_20px_0px_theme(colors.glow)] hover:scale-105 focus:outline-none focus:ring-4 focus:ring-glow/50">
