...
function StatusPopup({ isOpen, onClose, jobId, paymentUrl }) {
  ...
  const handleDownload = () => {
    if (jobId) {
      const downloadUrl = `https://650f7f54388b.ngrok-free.app/download/${jobId}`;
    ...
    const pollStatus = async () => {
      ...
      try {
        const response = await fetch(
          `https://650f7f54388b.ngrok-free.app/status/${jobId}`,
          {
            method: "GET",
            headers: {
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      <div>
                        ...
                        <p className="text-lg font-semibold text-gray-900 dark:text-white truncate mt-1">
                          {status.filename}
                        </p>
                      </div>
                      <div>
                  ...
                  <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-6 border border-blue-200 dark:border-blue-800">
                    <div className="text-center">
                      ...
                      <p className="text-blue-600 dark:text-blue-300 mb-6">
                        Complete your payment to start processing your audio
                        file.
                      </p>
                      <button
                  ...
                  <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl p-6 border border-green-200 dark:border-green-800">
                    <div className="text-center">
                      ...
                      <p className="text-green-600 dark:text-green-300 mb-6">
                        Your audio has been successfully cleaned and is ready
                        for download.
                      </p>
                      <button
